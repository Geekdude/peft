...
def schedule_dag(dag, computation_matrix=W0, communication_matrix=C0, proc_schedules=None, time_offset=0, relabel_nodes=True, manual_order=[], include_idle=False):
    """
...
if __name__ == "__main__":
    ...
    processor_schedules, task_schedules, dict_output = schedule_dag(dag, communication_matrix=communication_matrix, computation_matrix=computation_matrix, manual_order=order, include_idle=args.idle)
